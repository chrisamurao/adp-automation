...
VALUES
(batch_id_, 12, 'Manually Inserted Status - Zipped on Jose Local', '2019-MM-DD _zip_start_time_'),
(batch_id_, 13, 'Manually Inserted Status - Zipped on Jose Local', '2019-MM-DD _zip_finish_time_'),
(batch_id_, 15, 'Manually Inserted Status - sFTP from Jose Local', '2019-MM-DD _sftp_start_time_'),
(batch_id_, 16, 'Manually Inserted Status - sFTP from Jose Local', '2019-MM-DD _sftp_finish_time_');
...
WHERE ch.adp_batch_id = batch_id_ AND
